...
find_subtrees = False # Find and merge subtrees
merge_subtrees_min_similarity = 0.45 # Threshold for the similarity of the subtrees. If the calculated similarity exceeds the threshold, the subtrees are merged
